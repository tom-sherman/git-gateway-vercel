module github.com/tom-sherman/git-gateway-vercel-demo
...
require (
	...
	github.com/go-chi/chi v3.1.4+incompatible // indirect
	...
	github.com/tom-sherman/git-gateway-vercel v1.0.0 // indirect
